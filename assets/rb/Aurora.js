// Port of React Bits <Aurora> (OGL) to a vanilla ES module. Shaders are verbatim from the source.
...
export default function mount(el, opts = {}) {
  const { colorStops = ['#5227FF', '#7cff67', '#5227FF'], amplitude = 1.0, blend = 0.5, lightMode = false, speed = 1.0 } = opts;
